 ...
 * Comprehensive metrics collection for DobbyX performance monitoring
 */
...
// Custom metrics for DobbyX
export const metrics = {
  // HTTP Request metrics
  httpRequestDuration: new prometheus.Histogram({
    name: 'dobbyx_http_request_duration_seconds',
  ...
  httpRequestsTotal: new prometheus.Counter({
    name: 'dobbyx_http_requests_total',
  ...
  discordCommandsTotal: new prometheus.Counter({
    name: 'dobbyx_discord_commands_total',
  ...
  discordCommandDuration: new prometheus.Histogram({
    name: 'dobbyx_discord_command_duration_seconds',
  ...
  discordInteractionsTotal: new prometheus.Counter({
    name: 'dobbyx_discord_interactions_total',
  ...
  aiTokensUsed: new prometheus.Counter({
    name: 'dobbyx_ai_tokens_used_total',
  ...
  databaseConnections: new prometheus.Gauge({
    name: 'dobbyx_database_connections',
    help: 'Number of active database connections'
  }),

  // Error metrics
  errorsTotal: new prometheus.Counter({
    name: 'dobbyx_errors_total',
  ...
  memoryUsage: new prometheus.Gauge({
    name: 'dobbyx_memory_usage_bytes',
    help: 'Memory usage in bytes',
    labelNames: ['type']
  }),

  eventLoopLag: new prometheus.Histogram({
    name: 'dobbyx_event_loop_lag_seconds',
