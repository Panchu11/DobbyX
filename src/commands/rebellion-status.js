    ...
    async execute(interaction, game) {
        ...
        try {
            ...
            if (!rebel) {
                ...
                const welcomeMessage = await dobby.generateWelcomeMessage(username);
                
                const embed = new EmbedBuilder()
                    .setColor(0xff4444)
                    .setTitle('🔥 JOIN DOBBY\'S REBELLION')
            ...
            const dailyMission = await dobby.generateDailyMission(rebel.class, rebel.loyaltyScore);
            ...
            console.error('Rebellion status error:', error);
            await interaction.editReply({
                content: '💥 The rebellion systems are under attack! Try again, rebel!',
                components: []
            });
        }
    }
