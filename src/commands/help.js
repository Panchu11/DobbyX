...
export default {
    ...
    async handleCommandsHelp(interaction, game) {
        ...
        if (category && commandCategories[category]) {
            ...
            embed = new EmbedBuilder()
                ...
                .setDescription('**Complete command reference for Dobby\'s Rebellion**')
                .addFields(
    ...
    async handleQuickStart(interaction, game) {
        const embed = new EmbedBuilder()
            ...
            .setDescription('**Get started in Dobby\'s Rebellion in 5 minutes!**')
            .addFields(
    ...
    async handleMechanicsHelp(interaction, game) {
        ...
        if (topic && mechanics[topic]) {
            ...
            embed = new EmbedBuilder()
                ...
                .setDescription('**Learn the core systems of Dobby\'s Rebellion**')
                .addFields(
