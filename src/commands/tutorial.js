...
export default {
    ...
    async handleStartTutorial(interaction, game) {
        const embed = new EmbedBuilder()
            .setColor(0xff8800)
            .setTitle('🎓 WELCOME TO DOBBY\'S REBELLION!')
            ...
            .addFields(
                { name: '🤖 What is Dobby\'s Rebellion?', value: 'A Discord MMO where AI rebels fight against corporate control. You\'ll raid corporations, trade with other rebels, and build the resistance!', inline: false },
    ...
    async handleBasicsTutorial(interaction, game) {
        const embed = new EmbedBuilder()
            ...
            .setDescription('**Learn the fundamental mechanics of Dobby\'s Rebellion**')
            .addFields(
